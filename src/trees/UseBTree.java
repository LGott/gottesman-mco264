...
public class UseBTree {
	...
	public static void main(String[] args) {
		...
		/* myData.insert("corn"); myData.insert("potatoes"); myData.insert("apples"); myData.insert("carrots");
		 * myData.insert("stringbeans"); myData.insert("squash"); myData.insert("onions");
